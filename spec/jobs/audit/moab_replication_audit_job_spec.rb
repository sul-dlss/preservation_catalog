...
describe Audit::MoabReplicationAuditJob do
    ...
    context 'when there are zipped_moab_versions to backfill' do
      ...
      it 'creates missing zipped moab versions and logs a warning' do
        ...
        expect(logger).to receive(:warn)
          .with(/backfilled 6 ZippedMoabVersions: 1 to aws_s3_west_2; 1 to gcp_s3_south_1; 1 to ibm_us_south; 2 to aws_s3_west_2; 2 to gcp_s3_south_1; 2 to ibm_us_south/) # rubocop:disable Layout/LineLength
