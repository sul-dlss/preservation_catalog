...
server 'preservation-catalog-web-qa-01.stanford.edu', user: 'pres', roles: %w[app db web]
server 'preservation-catalog-web-qa-02.stanford.edu', user: 'pres', roles: %w[app db web]
