module PreservationCatalog
  module Ibm
    ...
    class Audit
      ...
      # NOTE: no checksum computation is happening here (neither on our side, nor on IBM's).  we're just comparing
      # the checksum we have stored with the checksum we asked IBM to store.  we really don't expect any drift, but
