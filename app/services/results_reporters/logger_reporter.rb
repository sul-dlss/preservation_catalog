...
module ResultsReporters
  ...
  class LoggerReporter < BaseReporter
    ...
    def logger_severity_level(result_code)
      case result_code
      when Results::DB_OBJ_DOES_NOT_EXIST, Results::ZIP_PARTS_NOT_CREATED, Results::ZIP_PARTS_NOT_ALL_REPLICATED
        Logger::WARN
      when Results::VERSION_MATCHES, Results::ACTUAL_VERS_GT_DB_OBJ, Results::CREATED_NEW_OBJECT,
          Results::MOAB_RECORD_STATUS_CHANGED, Results::MOAB_CHECKSUM_VALID
        Logger::INFO
      else
        Logger::ERROR
      end
